...
#
# 입력
# 첫 번째 줄에는 보드의 세로, 가로 크기를 의미하는 두 정수
# N, M (3 ≤ N, M ≤ 10)이 주어진다.
...
# 리스트 컴프리헨션으로 특정 크기의 2차원 리스트 초기화
...
for i in range(len(board)):
    ...
    # 빨간공 파란공 위치 찾기
    # 구멍 위치 찾기
    # if board[i].index('R') != None:
    #     redPos = board[i].index('R');
    # if board[i].index('B') != None:
    #     bluePos = board[i].index('B');
    # if board[i].index('0') != None:
    #     holePos = board[i].index('0');

print(redPos, bluePos, holePos)
